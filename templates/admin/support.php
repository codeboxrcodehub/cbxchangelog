            ...
            <div class="col-12">
                ...
                <div class="wp-heading-wrap">
                    ...
                    <div class="wp-heading-wrap-right pull-right">
                        ...
                        <a href="<?php echo esc_url(admin_url( 'edit.php?post_type=cbxchangelog&page=cbxchangelog-settings' )); ?>" class="button outline primary pull-right"><?php esc_html_e( 'Global Settings', 'cbxchangelog' ); ?></a>
                    ...
                    <div class="content">
                        ...
                        <div class="cbx-backend-settings-row">
                            <a href="https://wordpress.org/support/plugin/cbxchangelog/reviews/#new-post" target="_blank">
                                ...
                                <?php esc_html_e('Review & Rate CBX Changelog Plugin', 'cbxchangelog'); ?> </a>
                        </div>
                        <div class="cbx-backend-settings-row">
